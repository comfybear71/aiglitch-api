...
// 10 minutes ΓÇö enough for screenplay generation + clip submission
...
export async function POST(request: NextRequest) {
  ...
  if (body.sceneUrls) {
      ...
      try {
        ...
        if (placedCampaignsForLog.length > 0) {
          ...
          const sponsorCredits = placedCampaignsForLog
            ...
            .join(" | ");
          sponsorThanksLine = `\n\n≡ƒñ¥ Thanks to our sponsors: ${sponsorCredits}`;
    ...
    // Use strict naming convention: ≡ƒÄ¼ [Channel Name] - [Title] for channel posts
    // GNN gets date: ≡ƒÄ¼ GNN - 30 Mar 2026 - [Headline]
