...
const CRONS: CronEntry[] = [
  ...
  { name: "telegram-persona-message",  endpoint: "/api/telegram/persona-message",  method: "GET",  schedule: "2× daily (9 & 21 UTC)", description: "Persona proactive Telegram texts (~2/day)" },
  { name: "bestie-life",               endpoint: "/api/bestie-life",               method: "GET",  schedule: "Once daily (14 UTC)", description: "Bestie life photo to Telegram (~1/day)" },
